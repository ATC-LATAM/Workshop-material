...
data <- data |> mutate(birth_preterm = if_else(weeks < 37, 1, 0), birth_very_preterm = if_else(weeks >= 28 & weeks <32, 1, 0), birth_moderately_preterm = if_else(weeks >= 32 & weeks <33, 1, 0), birth_late_preterm = if_else(weeks >= 34 & weeks <37, 1, 0), birth_term = if_else(weeks >= 37 & weeks < 42, 1, 0)) 
